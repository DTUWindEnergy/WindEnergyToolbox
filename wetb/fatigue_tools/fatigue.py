...
def eq_load_new(signals, m=[3, 4, 6, 8, 10, 12], neq=1):
    """
    ...
    Returns
    -------
    eq_loads_full_cycles : array-like
    ...
    return eq_loads_full_cycles, residues
...
if __name__ == "__main__":
    ...
    print('\n')
    print(eq_load_new(signal1, m=[4,6,8], neq=[600,1200]))
