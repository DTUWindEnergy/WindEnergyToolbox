...
class StFile(object):
    ...
    - I_x : area moment of inertia with respect to principal bending xe axis [m4]. This is the principal bending axis most parallel to the xc2 axis
    - I_y : area moment of inertia with respect to principal bending ye axis [m4]
    ...
    - y_e : yc2-coordinate from C1/2 to center of elasticity [m]. The elastic center is the point where radial force (in the
