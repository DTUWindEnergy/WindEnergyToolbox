...
# find+xargs mode: 1 PBS job, multiple cases
  ...
  (time WINEARCH=win32 WINEPREFIX=~/.wine32 numactl --physcpubind=$CPU_NR wine hawc2-latest ./htc/dlc01_demos/dlc01_steady_wsp11_s101.htc) |& tee pbs_out/dlc01_demos/dlc01_steady_wsp11_s101.err.out 
fi
# ------------------------------------------------------------------------------
